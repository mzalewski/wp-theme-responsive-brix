...
function hoot_of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'hoot' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'hoot' ),
		'repeat-y'  => __( 'Repeat Vertically', 'hoot' ),
		'repeat'    => __( 'Repeat All', 'hoot' ),
		);
...
function hoot_of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'hoot' ),
		'top center'    => __( 'Top Center', 'hoot' ),
		'top right'     => __( 'Top Right', 'hoot' ),
		'center left'   => __( 'Middle Left', 'hoot' ),
		'center center' => __( 'Middle Center', 'hoot' ),
		'center right'  => __( 'Middle Right', 'hoot' ),
		'bottom left'   => __( 'Bottom Left', 'hoot' ),
		'bottom center' => __( 'Bottom Center', 'hoot' ),
		'bottom right'  => __( 'Bottom Right', 'hoot')
		);
...
function hoot_of_recognized_background_type() {
	$default = array(
		'predefined' => __( 'Predefined Pattern', 'hoot' ),
		'custom'     => __( 'Custom Image', 'hoot' ),
		);
...
function hoot_of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'hoot' ),
		'fixed'  => __( 'Fixed in Place', 'hoot')
		);
...
function hoot_of_recognized_font_styles() {
	$default = array(
		'none'                     => __( 'None', 'hoot' ),
		'italic'                   => __( 'Italic', 'hoot' ),
		'bold'                     => __( 'Bold', 'hoot' ),
		'bold italic'              => __( 'Bold Italic', 'hoot' ),
		'lighter'                  => __( 'Light', 'hoot' ),
		'lighter italic'           => __( 'Light Italic', 'hoot' ),
		'uppercase'                => __( 'Uppercase', 'hoot' ),
		'uppercase italic'         => __( 'Uppercase Italic', 'hoot' ),
		'uppercase bold'           => __( 'Uppercase Bold', 'hoot' ),
		'uppercase bold italic'    => __( 'Uppercase Bold Italic', 'hoot' ),
		'uppercase lighter'        => __( 'Uppercase Light', 'hoot' ),
		'uppercase lighter italic' => __( 'Uppercase Light Italic', 'hoot' )
		);
